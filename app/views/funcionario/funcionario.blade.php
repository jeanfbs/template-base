@extends("template")
@section("title")   {{trans(Config::get("app.locale").".title_funcionario")}}    @stop
@section("content")
<!--Start Breadcrumb-->
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#">{{trans(Config::get("app.locale").".title_funcionario")}}</a></li>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>{{trans(Config::get("app.locale").".title_funcionario")}}</span>
				</div>
			...
			<div class="box-content">
				<div id="tabs">
					<ul>
						<li><a href="{{url('panel-control/funcionario/cadastro')}}">{{trans(Config::get("app.locale").".tab_sign")}}</a></li>
						<li><a href="{{url('panel-control/funcionario/pesquisa')}}">{{trans(Config::get("app.locale").".tab_search")}}</a></li>
					</ul>
					<div id="tabs-2">
