$(document).ready(function() {
	...
	var actions_buttons ='<a class="view"><i class="fa fa-eye" data-toggle="tooltip" data-placement="left" title="'+$('#tabela_$filename').attr("tipview")+'"></i></a> ';
		actions_buttons += '<a data-toggle="modal" data-target="#edit" class="editar"><i class="fa fa-edit" data-toggle="tooltip" data-placement="left" title="'+$('#tabela_$filename').attr("tipedit")+'"></i></a> ';
		actions_buttons += '<a href="#deletar" class="del"><i class="fa fa-trash" data-toggle="tooltip" data-placement="left" title="'+$('#tabela_$filename').attr("tipdel")+'"></i></a>';		    					 
